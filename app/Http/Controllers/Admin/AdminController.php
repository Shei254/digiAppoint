...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $completed = Appointment::where('status', Status::COMPLETED_APPOINTMENT)->count();
        $pending = Appointment::where('status', Status::UPCOMING_APPOINTMENT)->count();
        $staff = User::where('is_staff', Status::YES)->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'depositsMonth', 'months', 'totalAppointment', 'completed', 'pending', 'staff'));
    }
