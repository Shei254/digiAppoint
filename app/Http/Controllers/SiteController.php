...
class SiteController extends Controller
{
    ...
    public function pricing()
    {
        ...
        $seoContents = $sections->seo_content;
        $seoImage = @$seoContents->image ? getImage(getFilePath('seo') . '/' . @$seoContents->image, getFileSize('seo')) : null;
        return view('Template::pricing', compact('pageTitle', 'sections', 'pricing','seoContents','seoImage'));
    }
    ...
    public function blogDetails($slug)
    {
        ...
        $latestBlogs = Frontend::where('data_keys', 'blog.element')->latest()->orderBy('created_at', 'desc')->take(5)->get();
        $pageTitle   = "Blog Details";
        $seoContents = $blog->seo_content;
        $seoImage = @$seoContents->image ? frontendImage('blog',$seoContents->image,getFileSize('seo'),true) : null;

        return view('Template::blog_details', compact('blog', 'pageTitle', 'seoContents', 'latestBlogs','seoImage'));
    }
