...
@section('content')
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-lg-9 custom--card card">
                                    ...
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text" class="form-control form--control amount bg-white" name="amount"
                                                    placeholder="@lang('00.00')" value="{{ getAmount(@$amount) }}" autocomplete="off" readonly>
                                                    <input type="hidden" step="any" name="pricing_id" class="form-control form--control" value="{{ $pricing->id }}"
                                                    required>

                                                <input type="hidden" step="any" name="time" class="form-control form--control" value="{{ $time }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
...
@push('style')
    <style>
        .bg-white.form--control:disabled, .bg-white.form--control[readonly]{
