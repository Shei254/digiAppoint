                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                ...
                                <x-image-uploader name="dark_logo" :imagePath="siteLogo('dark') . '?' . time()" :size="false" class="bg-dark w-100" id="uploadDarkLogo" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Logo for Base Background')</label>
                                <x-image-uploader name="base_logo" :imagePath="siteLogo('base') . '?' . time()" :size="false" class="bg-dark w-100" id="uploadBaseLogo" :required="false" />
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
