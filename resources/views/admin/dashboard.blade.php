...
@section('panel')
    ...
    <div class="row mt-2 gy-4">
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Appointments')</h5>
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ getAmount(@$totalAppointment) }}</h6>
                                    <p class="widget-card-title">@lang('Total Appointment')</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-card bg--warning">
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ getAmount(@$completed) }}</h6>
                                    <p class="widget-card-title">@lang('Completed Appointment')</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-card bg--danger">
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ getAmount(@$pending) }}</h6>
                                    <p class="widget-card-title">@lang('Pending Appointment')</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-card bg--primary">
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ getAmount(@$staff) }}</h6>
                                    <p class="widget-card-title">@lang('Total Staff')</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between">
                    <h5 class="card-title">@lang('Monthly Payment Report') (@lang('Last 12 Month'))</h5>
